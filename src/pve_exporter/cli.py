...
def main():
    ...
    nodeflags.add_argument(
        "--collector.agent",
        dest="collector_agent",
        action=BooleanOptionalAction,
        default=True,
        help="Exposes PVE QEMU agent info",
    )
    ...
    logger = logging.getLogger("pve_exporter")
    logger.info(f"Starting PVE exporter with log level: {params.log_level}")
